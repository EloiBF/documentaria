...
def generate_embeddings(file_paths, languages):
    ...
    client = chromadb.Client(Settings(chroma_db_impl="duckdb+parquet", persist_directory="databases/embedding/chroma_db"))
...
def crear_db_vectorial(directory='documents/embedding'):
    """
