...
from process_text_editor import Modify_Diccionarios, Modify_Bloques, DOCX_process, PPTX_process, Excel_process, PDF_process, TXT_process, HTML_process,Validar_Bloques
...
class Aplicar_Modelo:
    ...
    def modelo_edición(texto, add_prompt, model='llama-3.2-90b-vision-preview', api_key_file='API_KEY.txt'):
        """
