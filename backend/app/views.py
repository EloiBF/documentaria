...
# from doc_transcriber.app.main import transcribe_audio
# from doc_editor.app.main import editar_doc
# from doc_summarizer.app.main import resumir_doc
# from doc_analyze.app.main import extract_info_from_docs
# from doc_generate.app.main import generate_and_create_file
import pandas as pd
import logging
...
RESULT_FOLDER = settings.RESULT_ROOT
...
class DocumentTranslator(FileProcessor):
    ...
    def background_translation(self, file_path, result_file_path, language, origin_language, color_to_exclude, add_prompt):
        ...
        try:
            # Definir la URL del servicio de traducción
            url = "http://doc_translator:8006/translate"
