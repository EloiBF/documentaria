...
# Ruta absoluta para almacenar los archivos de medios
MEDIA_ROOT = os.path.join(BASE_DIR, 'documents')

# URL para acceder a los archivos de medios
MEDIA_URL = '/media/'

# Subcarpetas para uploads y downloads
...
SECRET_KEY = 'django-insecure-y)%t1ct18bsibh1=r4_4-1$r!)9@!@h6#)z(062%$3y%qh2&^r'
